...
const LiveDemo: React.FC = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // Show specific error message (e.g. missing API key)
      const message = err.message || "Tahlil qilishda xatolik yuz berdi.";
      setError(message);
    } finally {
      setLoading(false);
    }
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900 p-8 rounded-2xl shadow-xl relative overflow-hidden min-h-[400px] flex flex-col">
            ...
            <div className="flex-1 z-10">
              {error ? (
                 <div className="h-full flex flex-col items-center justify-center text-rose-400 gap-3 p-4 text-center">
